import { utils as MochaUtils } from "mocha";
...
export class MochaVErrorReporter extends Mocha.reporters.Base {
    ...
    static fullStack(error, indent = MochaVErrorReporter._DEFAULT_INDENT, indentLevel = 1) {
...
MochaVErrorReporter._DEFAULT_INDENT = "    ";
MochaVErrorReporter._REGEX_REMOVE_REPEATED_MESSAGE = /caused by.+\n/;
MochaVErrorReporter._REGEX_REPLACE_WITH_INDENT = /\n/g;
